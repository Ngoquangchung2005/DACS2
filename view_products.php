    ...
    function addToWishlist($user_id, $product_id)
    {
        ...
        if (mysqli_num_rows($select_price) > 0) {
            ...
            $insert_wishlist = mysqli_query($conn, "INSERT INTO wishlist (id, user_id, product_id, price) VALUES ('$id', '$user_id', '$product_id', '$price')");
            return true;
        }
        return false;
    }
    ...
    <head>
        ...
        <title>Green Coffee - Sản phẩm</title>
    </head>
