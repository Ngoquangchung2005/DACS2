    ...
    if (isset($_POST['forgot_submit'])) {
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            try {
                ...
                $mail->SMTPAuth = true;
                $mail->Username = 'chungnq.23ite@vku.udn.vn'; // Email của bạn
                $mail->Password = 'v p r o q o e h k q x q a i z x';   // Mật khẩu ứng dụng
                $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
                $mail->Port = 587;

                $mail->setFrom('your_email@gmail.com', 'GREEN TEA');
...
<head>
    ...
    <link rel="stylesheet" href="style.css"> <!-- Gọi CSS login -->
</head>
<body>
    <div class="main-container"> <!-- Class chung từ login -->
        <section class="form-container"> <!-- Class form từ login -->
            <div class="title">
